...
commonModule.factory('viewModelHelper', function ($http, $q) {
    return MyPlace.viewModelHelper($http, $q);
});
...
(function (mp) {
    var viewModelHelper = function ($http, $q) {
        ...
        self.apiGet = function (uri, data, success, failure, always) {
            self.isLoading = true;
            self.modelIsValid = true;
            $http.get(MyPlace.rootPath + uri, data)
        ...
        self.apiPost = function (uri, data, success, failure, always) {
            self.isLoading = true;
            self.modelIsValid = true;
            $http.post(MyPlace.rootPath + uri, data)
                .then(function (result) {
                    success(result);
                    if (always != null)
                        always();
    ...
    mp.viewModelHelper = viewModelHelper;
}(window.MyPlace));
